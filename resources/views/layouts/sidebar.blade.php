<div class="flex flex-col justify-between h-screen w-1/5 text-black pt-8 border-gray-300 border-r-2">
    <div class="flex flex-col items-start justify-center">
        ...
        <div class="mt-12 flex flex-col space-y-1 w-full">
            <a class="{{ Route::is('reports') ? 'bg-ccream transition-all duration-300 ease-in-out py-4' : 'hover:bg-ccream transition-all duration-300 ease-in-out py-4'}}" href="{{ route('reports') }}">
